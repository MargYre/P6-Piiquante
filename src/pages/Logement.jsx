    ...
    return (
        <div>
            ...
            <div className='logement-info'>
                ...
                <div className='side-by-side'>
                    <Accordion title="Description" content={Logements.find(l => l.id === logementId)?.description}/>
                    <Accordion title="Équipements" content={Logements.find(l => l.id === logementId)?.equipments}/>
                </div>
            </div>
        </div>
    );
